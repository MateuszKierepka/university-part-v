...
# wyswietlenie obrazu o indeksie 5, wiersze 10-28 i kolumny 0,2,4,...,28
plt.imshow(x_test[5, 10:29, 0:29:2], cmap="gray")
...
# kompilacja modelu
# categorical_crossentropy bo one-hot-encoding
model.compile(
    optimizer=Adam(learning_rate=0.001),
